...
router.put('/:id/estoque',   ctrl.ajustarEstoque);   // Ajuste manual de quantidade
router.get('/:id/consumos',  ctrl.historicoConsumo); // Histórico de consumo
